...
function start() {
	...
	tl.add("t1-in", "+=.2");
	tl.from(".t1a", { duration: .15, opacity: 0 }, "t1-in");

	tl.add("t1-out", "+=" + _commonJsCommonJs.SECOND.t1);
	tl.to(".t1a", { duration: .1, opacity: 0 }, "t1-out");

	tl.add("t2-in", "+=.2");
	tl.from(".t1c", { duration: .15, opacity: 0, y: "-=50" }, "t2-in");
	tl.from(".t1d", { duration: .15, opacity: 0, y: "+=50" }, "t2-in");

	tl.add("t2-out", "+=" + _commonJsCommonJs.SECOND.t2);
	tl.to(".t1c", { duration: .1, opacity: 0, y: "-=20" }, "t2-out");
	tl.to(".t1d", { duration: .1, opacity: 0, y: "+=20" }, "t2-out");
